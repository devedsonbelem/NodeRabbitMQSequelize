...
const ContratoBeneficiario = require('./src/model/ContratoBeneficiario');
...
const FatorModerador = require('./src/model/FatorModerador');
const GrupoCampoContrato = require('./src/model/GrupoCampoContrato');
const GrupoCampoContratoBeneficiario = require('./src/model/GrupoCampoContratoBeneficiario');
const LoteMovimentacao = require('./src/model/LoteMovimentacao');
const Movimentacao = require('./src/model/Movimentacao');
const Operadora = require('./src/model/Operadora');
const OrgaoEmissor = require('./src/model/OrgaoEmissor');
const Plano = require('./src/model/Plano');
const Profissao = require('./src/model/Profissao');
const RetornoLoteMovimentacao = require('./src/model/RetornoLoteMovimentacao');
const RetornoOperadora = require('./src/model/RetornoOperadora');
const SolicitacaoLoteMovimentacao = require('./src/model/SolicitacaoLoteMovimentacao');
const SolicitacaoRetornoLoteMovimentacao = require('./src/model/SolicitacaoRetornoLoteMovimentacao');
const SolicitacaoRetornoOperadora = require('./src/model/SolicitacaoRetornoOperadora');
const StatusLoteMovimentacao = require('./src/model/StatusLoteMovimentacao');
const StatusRetornoOperadora = require('./src/model/StatusRetornoOperadora');
const StatusSolicitacaoLoteMovimentacao = require('./src/model/StatusSolicitacaoLoteMovimentacao');
const SubContrato = require('./src/model/SubContrato');
const Supervisor = require ('./src/model/Supervisor');
const TipoArquivoMovimentacao = require('./src/model/TipoArquivoMovimentacao');
const TipoContratacao = require('./src/model/TipoContratacao');
const Tipoovimentacao = require('./src/model/TipoMovimentacao');
const Titular = require('./src/model/Titular');
...
var createContrato = function (req, res, next) {
	...
	contrato.save(async function (err, contrato) {
		...
		if (err) {
			...
			let codigoUfIbge;
			await axios.get(`https://consulta-api.hmg.m.com.br/api/v1/municipios/${contrato.titular.endereco.uf}`, {
				headers: {
...
var solicitarLoteMovimentacao = function (req, res){
	
	var id_StatusLoteMovimentacao = req.body.id_StatusLoteMovimentacao;
	
	SolicitacaoLoteMovimentacao.create({
	
	id_StatusLoteMovimentacao:id_StatusLoteMovimentacao	
	}).then(()=>{
		res.send("Solicitação gerada com sucesso!");
	});	
...
router.route('/solicitacao')
	.post(solicitarLoteMovimentacao)

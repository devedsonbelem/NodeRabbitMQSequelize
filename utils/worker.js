...
// amqp.connect('amqp://hadministradora:h4Dm1n44@10.190.4.17', function (err, conn) {
    amqp.connect(process.env.API_WORKER_HADM, function (err, conn) {
    conn.createChannel(function (err, ch) {
        ...
        ch.consume(q, function
            ...
            this.keyHash = CryptoJS.SHA256(CryptoJS.enc.Utf8.parse(process.env.WORKER_PRIVATE_KEY));
            ...
            // const sequelize = new Sequelize("m01","root","coti",{
            //     host:"localhost",
            //     dialect: "mysql",
            ...
            MongoClient.connect(url, async function (err, database) {
                if (err) {
                    ...
                    await axios.get(`https://consulta-api.hmg.m.com.br/api/v1/municipios/${contratoBeneficiario.titular.endereco.uf}`, { //work2
                        headers: {
